<template>
  <div class="grid grid-cols-12 bg-gradient-to-t from-amber-300 to-orange-50">
    ...
    <div class="col-span-8 p-4 place-content-center">
      ...
      <form class="mt-8">   
          ...
          <div class="relative">
              ...
              <input v-model='searchText' type="search" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-3xl bg-gray-50 focus:ring-orange-400 focus:border-orange-400" placeholder="Search Guides" required>
      ...
      <div id="beginner" class="fixed-container">
        ...
        <div class="border-4 border-black rounded-3xl p-4 bg-green-200 overflow-x-auto overflow-hidden flex first:pl-6 last:pr-6">
          ...
          <ResourceGuidesCard v-for="guide in ResourceGuideList1"
      ...
      <div id="intermediate" class="fixed-container mb-8">
          ...
          <div class="border-4 p-4 rounded-3xl border-black bg-green-300 overflow-x-auto overflow-hidden flex">
            <ResourceGuidesCard v-for="guide in ResourceGuideList2"
            :title="guide.comp.title"
            :image="guide.comp.image"
            :url1="guide.comp.url">
            </ResourceGuidesCard>
    ...
    <div class="border-4 border-black rounded-3xl my-4 p-4 bg-green-200 overflow-x-auto overflow-hidden flex first:pl-6 last:pr-6" v-else-if="filteredResourceGuideList.length > 0">
        <ResourceGuidesCard v-for="guide in filteredResourceGuideList"
            :title="guide.comp.title"
            :image="guide.comp.image"
            :url1="guide.comp.url">
          </ResourceGuidesCard>
...
export default {
  ...
  data(){
    return {
    ResourceGuideList1:[{search:'how to make a basic compost',comp:{title:'Make a Basic Compost',image:'ResourceGuidesCards/compostbin1.png',url:'/basiccompost'}},
    {search:'how to build a composting bin',comp:{title:'Build a Composting Bin',image:'ResourceGuidesCards/compostbin.png',url:''}},
    {search:'how to keep your compost warm', comp:{title:'Keep your Compost Warm', image:'ResourceGuidesCards/warm.png', url:''}},
    {search:'how to speed up composting process',comp:{title:'Speed up Composting Process', image:'ResourceGuidesCards/time.png', url:''}},
    {search:'how to keep your compost from smelling', comp:{title:'Keep your Compost from Smelling', image:'ResourceGuidesCards/odor.png', url:''}},
    {search:'how to process food waste before using it', comp:{title:'Process Food Waste before using', image:'ResourceGuidesCards/food.png', url:''}}],
    
    ResourceGuideList2:[{search:'how to build a tumbling composter',comp:{title:'Build a Tumbling Composter',image:'ResourceGuidesCards/tumbling.png',url:''}},
    {search:'how to apply mulch to compost',comp:{title:'Apply Mulch to Compost',image:'ResourceGuidesCards/mulch.png',url:''}},
    {search:'how to make a worm compost system', comp:{title:'Make a Worm Compost System', image:'ResourceGuidesCards/wormcompost.png', url:''}},
    {search:'how to upscale your compost bin',comp:{title:'Upscale your Compost Bin', image:'ResourceGuidesCards/compostbox.png', url:''}},
    {search:'how to make compost tea', comp:{title:'Make Compost Tea', image:'ResourceGuidesCards/composttea.png', url:''}},
    {search:'how to add nitrogen to compost', comp:{title:'Add Nitrogen to Compost', image:'ResourceGuidesCards/nitrogen.png', url:''}}],
