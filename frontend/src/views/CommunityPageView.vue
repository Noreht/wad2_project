...
<template>
  <div class="grid grid-cols-12 gap-4 z-20">
    ...
    <div class="col-span-8 z-10">
      ...
      <!-- chat component -->
      <div class="fixed bottom-0 right-80 mb-4 mr-4">
        <button
          id="open-chat"
      ...
      <div id="chat-container" class="hidden fixed bottom-16 right-80 w-96">
        <div class="bg-white shadow-md rounded-lg max-w-lg w-full">
          <div
            class="p-4 border-b bg-blue-500 text-white rounded-t-lg flex justify-between items-center"
          >
            <p class="text-lg font-semibold">Tharmen .S</p>
            <button
              id="close-chat"
    ...
    <div class="col-span-2 pt-50 lg:block flex flex-row-reverse">
      <suspense>
        <UserSidebarRight />
      </suspense>
    </div>
