    ...
    <div class="col-span-8">
      ...
      <div class="relative isolate py-10">
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
          ...
          <div
            class="flex min-h-full flex-1 flex-col justify-center sm:px-6 lg:px-8"
          >
            <div class="sm:mx-auto sm:w-full sm:max-w-xxl mt-10">
              <div
                class="min-w-[400px] bg-white px-6 py-2 shadow-xl sm:rounded-lg sm:px-12 border-4 border-black rounded-3xl"
              >
