      ...
      >
        ...
        >
          <span
            ...
            :class="{
              'text-amber-400':
                index >= typewriterText.length - 5 &&
                index <= typewriterText.length - 1,
            }"
            >{{ char }}</span
          >
        </h1>
        ...
        <div class="flex justify-center">
          <div class="mt-8 grid grid-cols-2 gap-y-12 max-w-[700px] gap-x-12">
            ...
            <marketplacecard
              v-else-if="filteredProductList.length > 0"
  ...
  <div v-else >
    <div class="grid grid-cols-12 min-w-[400px] h-full">
      ...
      >
        ...
        <div
          class="mt-8 gap-y-12 sm:gap-x-6 xl:gap-x-8 flex flex-col items-center justify-center"
        >
          <marketplacecard
            v-if="searchText == ''"
            v-for="product in products"
