...
import { document as document1, updatedoc, arrayunion, setdoc, Query, Collection, Where, getdocs, db} from "@/utils/firebase/firebaseInit.js";
...
export default {
  ...
  methods: {
    ...
    async isDisabled(modalTitle) {
      ...
      await setdoc(document1(db, "UserCommunities", id.toString()), {name: modalTitle} )
