          ...
          <div class="hidden lg:ml-6 lg:block">
            <div class="flex space-x-4">
              ...
              <!-- <a href="/communities" :class="getClass('/communities')">Communities</a>
               -->
              <a v-if="checkPageLoggedIn" href="/communities" :class="getClass('/communities')">Communities</a>
               <a v-else="" data-modal-target="medium-modal" data-modal-toggle="medium-modal" :class="getClass('/communities')">Communities</a>
                    ...
                    <!-- Modal body -->
                      <div class="p-6 space-y-6">
                        <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                          To embark on your journey and discover the vibrant world of composting communities in Singapore, start by logging in if you're already part of our community. If you haven't registered yet, it's a breeze, and registration unlocks a myriad of benefits and opportunities. Join us now and explore the wonderful world of composting collaborations!
                        </p>
                      </div>

                      <!-- Modal footer -->
                      <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <button data-modal-hide="medium-modal" type="button" class="text-white bg-amber-400 hover:bg-amber-500 focus:ring-4 focus:outline-none focus:ring-gray-900 hover:border-gray-900 hover:border-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-amber-400 dark:hover:bg-amber-500 dark:focus:ring-amber-800 transition-all duration-200 ease-in-out" @click="$router.push('/login')">Login</button>
                        <button data-modal-hide="medium-modal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-900 hover:border-gray-900 hover:border-4 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-black dark:hover:text-white dark:hover:bg-black dark:focus:ring-gray-900 transition-all duration-200 ease-in-out" @click="router.push('/registration')">Register Account</button>
                      </div>
                        </div>
                    </div>
                </div>
