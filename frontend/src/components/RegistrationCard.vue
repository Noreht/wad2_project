        ...
        <img class=" h-20 w-auto" src="BlackGoldIcon.svg" alt="BlackGold Icon" />
          ...
          <form class="space-y-6 mt-5" action="#" method="POST">
            ...
            <div>
                <label for="fullname" class="block text-sm font-medium leading-6 text-gray-900">Full Name</label>
                    <div class="mt-1">
                        <input id="fullname" name="fullname" type="text" v-model="fullname" required="" class="block w-full border-0 py-1.5 text-gray-900 shadow-sm border-b-4 border-gray-500 placeholder:text-gray-400 focus:border-b-8 focus:border-gray-600 focus:ring-0 sm:text-sm sm:leading-6 transition-all duration-200 ease-in-out" />
                    </div>
            </div>
            ...
            <div>
                <label for="password" class="block text-sm font-medium leading-6 text-gray-900">Password</label>
                    <div class="mt-1">
                        <input id="password" name="password" type="password" v-model="password" autocomplete="current-password" required="" class="block w-full border-0 py-1.5 text-gray-900 shadow-sm border-b-4 border-gray-500 placeholder:text-gray-400 focus:border-b-8 focus:border-gray-600 focus:ring-0 sm:text-sm sm:leading-6 transition-all duration-200 ease-in-out" />
                    </div>
            </div>
            ...
            <div>
                <label for="confirmpassword" class="block text-sm font-medium leading-6 text-gray-900">Confirm Password</label>
                    <div class="mt-1">
                        <input id="confirmpassword" name="confirmpassword" type="password" v-model="confirmPassword" autocomplete="current-password" required="" class="block w-full border-0 py-1.5 text-gray-900 shadow-sm border-b-4 border-gray-500 placeholder:text-gray-400 focus:border-b-8 focus:border-gray-600 focus:ring-0 sm:text-sm sm:leading-6 transition-all duration-200 ease-in-out" />
                    </div>
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                <input id="acceptTandC" v-model="acceptTandC" name="acceptTandC" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-gray-600 focus:ring-gray-600" />
                <label for="acceptTandC" class="ml-3 block text-sm leading-6 text-gray-900 border-b border-gray-900 hover:border-b-4 transition-all duration-200 ease-in-out">
                    <a data-modal-target="medium-modal" data-modal-toggle="medium-modal" class="cursor-pointer">
                    ...
                    <div id="medium-modal" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative w-full max-w-lg max-h-full  border-[5px] border-black rounded-lg">
                            <!-- Modal content -->
                            <div class="relative bg-[#FFF8EB] rounded shadow dark:bg-gray-700 ">
                                <!-- Modal header -->
                                <div class="flex items-center justify-between p-5 border-b dark:border-gray-600">
                                    ...
                                    <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="medium-modal">
                                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                                            <path stroke="black" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                                        </svg>
                                    </button>
                                </div>
                                <!-- Modal body -->
                                ...
                                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                                    <button data-modal-hide="medium-modal" type="button" class="text-white bg-amber-400 hover:bg-amber-500 focus:ring-4 focus:outline-none focus:ring-gray-900 hover:border-gray-900 hover:border-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-amber-400 dark:hover:bg-amber-500 dark:focus:ring-amber-800 transition-all duration-200 ease-in-out">I ACCEPT</button>
                                </div>
                            </div>
                        </div>
                    </div>
          ...
          <div>
            ...
            <div class="flex mt-6 justify-center space-x-5">
              ...
              <a href="#" class="flex items-center justify-center rounded-full bg-[#f7f8fb] w-12 h-12 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#4285F4]">
                <img src="LoginCard/GoogleLogo.svg" alt="Discord Logo" class="h-6 w-6">
              </a>
  
              <a href="#" class="flex items-center justify-center rounded-full bg-[#E0E9FF] w-12 h-12 text-[#4285F4] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#4285F4]">
                <img src="LoginCard/FacebookLogo.svg" alt="Facebook Logo" class="w-full h-full">
              </a >
  
              <a href="#" class="flex items-center justify-center rounded-full bg-[#f7f8fb] w-12 h-12 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#4285F4]">
                <img src="LoginCard/DiscordLogo.svg" alt="Discord Logo" class="h-8 w-8">
              </a>
  
              <a href="#" class="flex items-center justify-center rounded-full bg-[#000000] w-12 h-12 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#4285F4]">
                <img src="LoginCard/XLogo.svg" alt="Discord Logo" class="h-6 w-6">
              </a>
