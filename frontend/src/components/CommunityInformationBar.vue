...
<div class="lg:flex lg:items-center lg:justify-between bg-amber-400 my-5 rounded-lg">
    <div class="min-w-0 flex-1">
      <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Punggol Community Warriors</h2>
