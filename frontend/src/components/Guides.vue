<template>
    <div class="grid grid-cols-12 bg-gradient-to-t from-amber-300 to-orange-50">
      ...
      <div class="col-span-8 p-4 place-content-center">
        ...
        >
            <div class="md:grid grid-cols-2 grid-rows-3">
                <div class="col-span-2">
                    <h2 class="mt-4 pl-8 text-4xl sm:text-5xl font-semibold">Do it together!</h2>
                    <h3 class="mt-4 pl-8 text-2xl sm:text-3xl font-semibold">What you'll need:</h3>
                </div>
                
                <div class="row-span-4">
                    <div class="md:grid md:grid-cols-2">
                        <div v-for="chunk in manipulateList" class="mb-4 mt-4 space-y-5">
                            <div v-for="item in chunk" class="pl-8 relative flex items-start">
                                ...
                                <div class="ml-3 sm:text-xl leading-6">
                                    <label :for="item" class=" sm:text-xl font-normal text-gray-500">{{ item }}</label>
                                </div>
                            </div>
                        </div>
                    </div>    
        ...
        <div class="relative">
            <img class="absolute w-32 -left-20 -top-10 -rotate-45" src="/quicktips.png">
            <div class=" rounded-3xl border-4 border-green-600 mt-5 min-w-[200px] shadow-2xl">
