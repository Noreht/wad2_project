<template>
  <a v-if="url1"
    :href="url1"
    class="me-3 w-[70%] max-w-[200px] min-w-[140px] flex-none rounded-2xl border-4 border-green-900"
  >
  ...
  >
    ...
    ></div>
    <div class=" px-3 py-2 bg-[rgb(0,0,0,)] rounded-b-xl">
      <div class="min-h-[100px] font-bold text-lg mb-2 italic">Coming Soon...</div>
